...
class Docker1C {
    private static ArrayList<String> run_shell_command(String command) throws IOException {
    ...
    static void create_1c_base(String server_1c, String server_sql, String ver,
        ...
        String b = path_to_1c + ver + Docker.path_rac;
    ...
    private static String get_infobase_description(String infobase_id, String rac_bin, String cluster_id
                                                    ) throws IOException {
        String command=rac_bin+" infobase --cluster=" + cluster_id + " info --infobase="+infobase_id;
        ArrayList<String> infobase = run_shell_command(command);
        String description = "";
    ...
    static void set_infobase_description(String server_1c, String ver, String path_to_1c, String infobase_name, String description) throws IOException {
        String b = path_to_1c + ver + Docker.path_rac;
        String rac_bin = Paths.get(b).toString();
        String rac_port= "";
        String[] server_1c_ver_with_ras = Docker.get_property(Docker.default_property, "server_1c_ver_with_ras", ",");
...
//TODO remove button
    ...
    static void add_infobase_to_list(String server_1c, String ver, String infobase, String infobase_name) throws IOException {
